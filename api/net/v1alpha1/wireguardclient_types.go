...
type WireguardClientSpec struct {
	...
	// Size defines the number of WireguardClient instances
...
type WireguardClientStatus struct {
	// Represents the observations of a WireguardClient's current state.
	// WireguardClient.status.conditions.type are: "Available", "Progressing", and "Degraded"
	// WireguardClient.status.conditions.status are one of True, False, Unknown.
	// WireguardClient.status.conditions.reason the value should be a CamelCase string and producers of specific
	// condition types may define expected values and meanings for this field, and whether the values
	// are considered a guaranteed API.
	// WireguardClient.status.conditions.Message is a human readable message indicating details about the transition.
